    ...
    for filename in os.listdir(directory):
        if filename.endswith(".txt"):
            ...
            for tactic in tactics:
                ...
                np.savez_compressed(f'../data/processed_tactics/{count}.npz', state=tensor, correct_move=parts[1], fen=parts[0])
                count+=1

read_and_process_files("../data/tactics/lichess_puzzle/")
